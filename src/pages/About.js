    ...
    return (
        <div className="container flex flex-col" data-aos='fade-up'>
            <div className="mx-auto w-11/12 mt-40 box-content lg:w-9/12">
                <h1 className="text-5xl font-bold lg:text-6xl ">Hai, im <span className="text-cyan-600">Yurdiansyah</span></h1>
                ...
                <div className="mt-16 w-full flex flex-col gap-6 md:flex-row">
                    <span className="py-2 text-center md:w-1/2 bg-sky-800 rounded-lg text-white font-semibold shadow-lg hover:scale-105 transition-all duration-500"><a href="http://github.com/yurdigrfn">Visit Github</a></span>
                    <span className="py-2 text-center md:w-1/2 text-white rounded-lg bg-indigo-800 shadow-lg hover:scale-105 transition-all duration-500"><a href="http://github.com/yurdigrfn">YouTube</a></span>
                </div>
            </div>
